...
-- like dashboard_auth. Same lockdown pattern: RLS on, no policies,
-- server-side only. This replaces the earlier localStorage-based
-- pinning so pins persist across browsers/devices instead of being
