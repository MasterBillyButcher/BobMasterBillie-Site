...
('veto', '🟣 Veto Power', $$<ul class="plain">
  <li>🚫 Lolwazi — 0 Active Veto Rights</li>
  <li>🚫 Chadboy_hz — 0 Active Veto Rights</li>
  <li>⭐ mickey_17__ gets one chance to earn VIP back.</li>
</ul>$$),

('backlog', '🎬 Movie Backlog (2)', $$<div class="note-block">The original list had 9 empty 🏷️ tag placeholders with no titles ever recorded, and a "(2)" count that didn't match the number of tags shown. Reproduced as-is rather than guessing — add real titles here going forward.</div>
<ul class="plain">
  <li>🏷️</li>
  <li>🏷️</li>
  <li>🏷️</li>
